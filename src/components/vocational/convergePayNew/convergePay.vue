...
<template>
    <dc-dialog v-if="visible" width="410" height="410" class="qr_pay" @close="handleScanClose">
        <div class="pay_content">
            ...
            <div class="pc_item" v-if="payStep==0">
                ...
                <el-input v-model="queryPay.authCode" class="pci_text authCode" @focus="scanInputErr=false" @blur="scanInputErr=true" @keyup.native="concatAuthcode" placeholder="请出示付款码" ref="scaningCode"></el-input>
