...
<template>
    <div class="apply">
        <div class="rep_query">
            ...
            <div class="rep_q_bottom">
                <div class="rep_qb_from">
                    ...
                    <!-- <div class="rep_qbf_item">
                        <div class="rep_qbfi_name">报名会员：</div>
                        <div class="rep_qbfi_label">
                            <el-input v-model="memberInfo.sv_mr_name" placeholder="选择会员" @focus="memberListStatus=true" clearable suffix-icon="el-icon-s-grid" @clear="handleMemberInfo()"></el-input>
                        </div>
                    </div> -->
                    <div class="rep_qbf_item">
        ...
        <dcDialog v-if="showRefundPassword" width="400" height="230" title="退款密码" @close="showRefundPassword = false" >
            <div class="password">
                <div class="pswBox"><el-input placeholder="请输入退款密码" v-model="refundPassword" type="password"></el-input></div>
                <div :class="['btnItem','btnPrimary',{disabled:refundPassword.length === 0}]" @click="handleRefundPassword">确定</div>
            </div>
        </dcDialog>
    </div>
</template>
