        ...
        <div class="rep_query">
            <div class="rep_top queryFilter">
                ...
                <div class="searchInput">
                    <!-- <el-input v-model.trim="queryEntity.keywards" placeholder="请输入班级" clearable @clear="handleSearch"
            ...
            <div class="rep_q_bottom">
                <div class="rep_qb_from">
                    ...
                    <div class="rep_qbf_item">
                        <div class="rep_qbfi_name">点名状态：</div>
                        <div class="rep_qbfi_label">
        ...
        <div class="req_table">
            <div class="tableBox SheetTable">
                <my-table ref="myTable"  :data="dataList || []">
                    ...
                    <my-table-cell label="点名时间" prop="sv_roll_call_time" width="160" showTooltip></my-table-cell>
                    ...
                    <my-table-cell label="点名状态" prop="sv_roll_call_state" width="80" showTooltip>
                        <template v-slot:default="row">
