...
export default {
    data() {
        return {
            ...
            cardTypes: [{ label: '全部', value: '' }, { label: '次卡', value: 0 }, { label: '期卡', value: 1 }],
            openCardStates: [{ label: "全部", value: "" }, { label: "已生效", value: true }, { label: "未生效", value: false }],
            dataList: [],
            total: 0,
            checkedJson: [],
            showGift: false,
    ...
    mounted() {
        ...
        this.GetGymSellingCourseCardList()
    },
    methods: {
        //#region  方法
        GetGymSellingCourseCardList() {
            ...
            stockApi.GetGymSellingCourseCardList(query).then(res => {
        ...
        handleDownload() { 
            ...
            stockApi.GetGymSellingCourseCardListExport(query).then(res => {
