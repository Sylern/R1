<!--会员押金退卡-->
<template>
    <div class="storeCardDepositReturn" ref="storeCardDepositReturn" v-if="dialogVisible" @keyup.enter.stop="handleSubmit" @keyup.esc.stop="closeDialogRecharge">
        <dc-dialog class="storeCardDepositReturn-dialog" v-if="showMain" width="560" height="8.4" title="储值卡退卡" @close="closeDialogRecharge">
            <div class="contentWrap">
                <div class="top">
                    <el-scrollbar ref="storeCardDepositReturnScroll" style="width: 100%; height: 100%;">
                        <div class="contentMain">
                            <div class="basicWrap">
                                <div class="userContent">
                                    <div class="userInfo">
                                        <div class="logo">
                                            ...
                                            <cmd-icon v-else type="icon-headDefault" size="30" color="#EB6100"></cmd-icon>
                                        </div>
                                ...
                                <div class="inputWrap">
                                    ...
                                    <div class="inputLine">
                                        <el-input class="input right" v-model="queryRecharge.sv_principal" disabled>
                                            <span slot="prepend">储值余额</span>
                                        </el-input>
                                    </div>
                                    <div class="inputLine">
                                        <el-input class="input right" v-model="queryRecharge.sv_gifts" disabled>
                                            <span slot="prepend">赠金余额</span>
                                        </el-input>
                                    </div>
                                    <div class="inputLine">
                            ...
                            <div class="payBox">
                                <div class="multiPay">
                                    <el-input class="input right" v-model="cardReturnMoney" disabled>
                                        <span slot="prepend">应退金额</span>
                                ...
                                <pay-type-list ref="payTypeListRecharge" isRecharge notSupportScan></pay-type-list>
                            </div>
                        </div>
                    </el-scrollbar>
                </div>
                <div class="btnWrap">
                    <div class="btnSure" repeatClick @click="handleSubmit">确定</div>
                </div>
            </div>
        </dc-dialog>
...
@import './storeCardDepositReturn.scss';
</style>
<script src="./storeCardDepositReturn.js"></script>