...
import discount from '@/modules/common/views/common/base/discount/discount.vue';
import priceChange from '@/modules/common/views/common/base/priceChange/priceChange.vue';
