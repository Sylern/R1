...
<template>
    <div class="cashierRoom">
        <div class="roomList" ref="roomList" v-show="!showCashier">
                        ...
                        <div class="listItem" :class="['status_' + item.sv_table_using_state]" v-for="(item, index) in dataList" :key="index" @click="handleListTable(item)">
                            ...
                            <div class="main">
                                ...
                                <div class="right" v-if="item.sv_switch" @click.stop="handleLightSwitch(item)">
                                    <cmd-icon class="btn_icon" type="icon-kaideng" size="24" color="var(--main-theme-color)"></cmd-icon>
                                </div>
                            </div>
                            <!-- 已开台 使用中展示 -->
            ...
            <div class="workerWrap" v-if="employeeList.length > 0">
                <div class="text">
                    <span>服务人员</span>
                </div>
                <div class="workerListWrap">
                    <el-scrollbar ref="workerListScroll" style="width: 100%; height: 100%;">
                        <div class="item" v-for="(item, index) in employeeList" :key="index">
        ...
        <t-cashier v-if="showCashier" :dataJson="dataJson" :isOrderBack="isOrderBack" @handleBack="onTable"></t-cashier>

        <dc-dialog v-if="showFnList" width="670" height="352" @close="showFnList = false">
            <div class="fnListContent">
                <div class="listWrap">
                    <div class="listItem" @click="handleFnItem('startOrderStatus')">
...
@import "./cashierRoom.scss"
</style>
<style lang="scss">
.cashierRoom .roomList .mainMenu .desk_mleft {
...
<script src="./cashierRoom.js"></script>
