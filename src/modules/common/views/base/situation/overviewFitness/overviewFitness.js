...
export default {
        ...
        return {
            ...
            fnListData: [
                ...
                },
                {
                    ...
                    name: '排课管理',
                    url: '/courseManage/courseSetManagement'
                },
                {
                    icon: base.frontImgBase + '/images/base/education/09.png',
                    name: '快速扣次',
                ...
                // },
                {
                    ...
                    name: '快速消课',
                    url: '/fitness_shortcuts'
                },
                {
                    icon: base.frontImgBase + '/images/base/education/06.png',
                    name: '批量消课',
                    url: '/fitness_multiple'
                },
                {
                    icon: base.frontImgBase + '/images/base/education/07.png',
                    name: '场地管理',
                    url: '/courseManage/gymFieldEntry'
                },
                {
                    icon: base.frontImgBase + '/images/base/education/10.png',
                    name: '扣周期卡',
                    isFn: true,
                    fnType: 'gymCardDeduction'
                },
                // {
            ...
            memberListStatus: false,            // 会员弹窗-抵扣周期卡
        }
    },
    computed: {
        ...mapState(['userInfo']),
    ...
    methods: {
        ...
        handleMemberInfo(memberItem) {
            if (this.isLoadingDeduction) return
            const query = {
                m_id: memberItem.member_id,
                sv_direction: 1,
                source: 100
            }
            this.isLoadingDeduction = true;
        },
