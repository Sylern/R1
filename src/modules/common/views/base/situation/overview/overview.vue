        ...
        <template >
            <div class="month-date">
                ...
                <div class="item">
                    ...
                    <div class="per">上月新增学员：{{ memberCourseDailySummaryRes.member_count_last || 0 }}</div>
                </div>
            </div>
            <div class="dataWrap">
                <div class="title">
                    <div class="des">学员分析</div>
                    <div class="right">
                ...
                <div class="message">
                    <div class="m-item"><span>消费学员：</span>注册学员中已转化下单的学员</div>
                    <div class="m-item"><span>上课学员：</span>消费学员中上课的学员数</div>
                    <div class="m-item"><span>下单-上课转化率：</span>上课学员数/消费学员数</div>
                </div>
                ...
                <div class="foot">
                    ...
                    <div class="item">
                        <div class="f-title"><span>学员潜力</span><span>解读</span></div>
                        <div class="f-des">
                            截止当前时间，漏斗中的消费学员平均每单消费<span>{{ memberReportRes.consume_amount_avg || 0 }}</span>元，
                            累计消费<span>{{ memberReportRes.consume_amount_total || 0 }}</span>元，
                            累计成交<span>{{ memberReportRes.consume_count_total || 0 }}</span>单,
                            上课学员平均<span>{{ memberReportRes.class_count_avg || 0 }}</span>天上一节课，
                            平均每节课价值<span>{{ memberReportRes.class_amount_avg || 0 }}</span>元
                        </div>
                    </div>
                    <div class="item">
                        <div class="f-title"><span>学员来源</span><span>解读</span></div>
                        <div class="f-des">
                            这段时间注册的学员， <template v-if="sourceRes.sv_ms_name_order"><span>{{ sourceRes.sv_ms_name_order }}</span>来源学员下单转化率最高，</template>
                            累计至当前已成交<span>{{ sourceRes.sv_order_count || 0 }}</span>单，
                            平均每单消费 <span>{{ sourceRes.sv_order_amount_avg || 0 }}</span>元，
                            <template v-if="sourceRes.sv_ms_name_class"><span>{{ sourceRes.sv_ms_name_class }}</span>学员上课转化率最高，</template>
            ...
            <div class="dataWrap">
                ...
                <div class="message">
                    <div class="m-item"><span>上课人数：</span>上课学员（已上课）</div>
                    <div class="m-item"><span>上课节数：</span>1V1、一对多(已上课)</div>
                </div>
                ...
                <div class="foot">
                    ...
                    <div class="item">
                        ...
                        <div class="f-des">
                            ...
                            上课人数中<span>{{ classReportRes.sex == 1 ? '男' : classReportRes.sex == '0' ? '女' : '未知性别' }}</span>学员较多，
                    ...
                    <div class="item">
                        ...
                        <div class="f-des">
                            1V1上课<span>{{ classReportRes.class_count_1v1 || 0 }}</span>节，
                            老师人均上课<span>{{ classReportRes.class_count_avg || 0 }}</span>节，
