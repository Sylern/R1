        ...
        <div class="rep_query">
            <div class="rep_top queryFilter">
                ...
                <div class="searchInput">
                    <el-input v-model.trim="queryEntity.search" placeholder="请输入学员姓名/电话" clearable @clear="handleSearch"
        ...
        <div class="req_table">
            <div class="tableBox SheetTable">
                <my-table ref="myTable" rowKey="sv_micard_id" :data="dataList || []" @select="handleSellect"
                    ...
                    <my-table-cell label="总课时|天" prop="sv_effective_class_hour_num_total" width="100" ></my-table-cell>
                    <my-table-cell label="购买课时|天" prop="sv_effective_class_hour_num" width="100" ></my-table-cell>
                    <my-table-cell label="赠送课时|天" prop="sv_give_class_hour" width="100" ></my-table-cell>
                    <my-table-cell label="已用课时|天" prop="sv_consumption_class_hour" width="100" ></my-table-cell>
                    <my-table-cell label="已退课时|天" prop="sv_refund_class_hour" width="100" ></my-table-cell>
                    <my-table-cell label="剩余课时|天" prop="sv_surplus_class_hour" width="100" ></my-table-cell>
                    <my-table-cell label="剩余过期课时|天" prop="sv_surplus_class_hour_overdue" width="130" ></my-table-cell>
                    <my-table-cell align="right" label="剩余金额" prop="sv_surplus_price" width="100" >
                        <template v-slot:default="row">
                            ￥{{ $app.moneyFixed(row.sv_surplus_price) }}
                        </template>
                    </my-table-cell>
                     <my-table-cell align="right" label="欠费课时|天" prop="sv_arrears_class_hour" width="100" ></my-table-cell>
