...
<template>
    <div class="expense">
            ...
            <div class="rep_q_bottom">
                <div class="rep_qb_from">
                    ...
                    <!-- <div class="rep_qbf_item">
                        ...
                        <div class="rep_qbfi_label">
                            <el-input v-model="memberInfo.sv_mr_name" placeholder="选择会员" @focus="memberListStatus = true" clearable suffix-icon="el-icon-s-grid"
        ...
        <div class="req_table">
            <div class="tableBox SheetTable">
                <my-table ref="myTable" rowKey="sv_micard_id" :data="dataList || []" @select="handleSellect"
                    ...
                    <my-table-cell align="right" label="消耗课时" prop="sv_consume_name" width="100" ></my-table-cell>
        ...
        <!-- 选择场地 -->
        <class-select title="选择场地" :visible.sync="classStatus" @handleSubmit="handleClassSubmit"></class-select>
    </div>
</template>
